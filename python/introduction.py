...
win.key_press(pv.KeyCode.Enter)
...
win.key_press("Enter")
pv.sleep(StringDelay)
# win.say_string("嗯，好像废话多了些，如果不希望我继续废话，请按一下键盘，随便哪个键都可以啦（等待按键空格...）")
...
win.key_press("Enter")
# win.say_string("哈，有了，我把一些好朋友使用我的例子介绍给你吧，想听的话就再按一下键盘吧（等待按键...）")
...
win.key_press("Enter")
pv.sleep(StringDelay)
# win.say_string("想让我演示的话就按一下键盘吧（等待按键...）")
